...
export default function Form() {
    return (
        <form className='form'>
            ...
            <input type = "date" name= "Date Of Birth" id="Date Of Birth"></input>
            </div>
            ...
            <input type="email" name = "confirm Email Address"></input>
            </div>

            <div id = "votersID">
            <label>Voter's Identification Number </label>
            <input type="number" name = "Voter's Identification Number"></input>
            </div>

            <div>
            <label>Voters Identification Card </label>
            <input type="file" name = "voterID"></input>
            </div>
